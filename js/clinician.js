$(document).ready(function () {
    ...
    $("#smenu .buttons a, #extra_box .buttons a").click(function () {
        href = $(this).attr('href');
		$('#extra_box').hide('fast');
        if (href == '#') {
            return false;
	...
	$('#i_multisearch').unbind('click');
	$('#i_multisearch').click(function(){
		$('#extra_box').toggle('fast');
		return false;
	});
	$('#extra_box a').click(function(){
		$('#extra_box').hide('fast');
	});
});
